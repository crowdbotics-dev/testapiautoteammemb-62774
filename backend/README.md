...
## Project Structure
    ...
    ├── testapiautoteammemb_62774  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_62774`
...
2. Clone this repo and `cd testapiautoteammemb_62774`
